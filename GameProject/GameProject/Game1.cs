...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            burger = new Burger(Content, "graphics\\burger", GameConstants.WindowWidth / 2, GameConstants.WindowHeight/ 8, null);
            // load audio content
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            for(int i=0; i<bears.Count;i++)
            {
                for(int j=i+1;j<bears.Count;j++)
                {
                    ...
                    {
                        CollisionResolutionInfo cri = CollisionUtils.CheckCollision(gameTime.ElapsedGameTime.Milliseconds, GameConstants.WindowWidth, GameConstants.WindowHeight, bears[i].Velocity, bears[i].CollisionRectangle, bears[j].Velocity, bears[j].CollisionRectangle);
                        if(cri != null)
                        {
        ...
        private void SpawnBear()
        {
            ...
            float bearSpeedValue = GameConstants.MinBearSpeed + RandomNumberGenerator.NextFloat(GameConstants.BearSpeedRange);
            ...
            // create new bear
            TeddyBear newBear = new TeddyBear(Content, "graphics\\teddybear", x, y, bearVelocity, null, null);
